...
def unitTest():
    ...
    session = TRCA(_Subject=9, fs=250)
...
def allCVTest():
    ...
    SubNum = [1, 2, 3, 4,5,6,7,8]
    print("================================================================")
    fig, ax = plt.subplots(figsize=(7, 5))
    plt.rcParams.update({'font.size': 12})
    ax.set_title('Accuracy (%)')
    for subNum in SubNum:
        averAcc = CVTest(SubNum=subNum)
        ax.bar(subNum, averAcc, color="#BA55D3", capsize=5)
